      ...
      <section className="crafter-profile-page">
        ...
        {loading && (
          <div className="loader">
            <span>
              <PulseLoader color={"#EA5800"} loading={loading} />
            </span>
              ...
              <section className="col-md-8">
                  ...
                  <div className="row crafter-basic-info">
                    ...
                    <div className="profile-info col-sm-8">
                      ...
                      <p className="location">
                        ...
                        <span>{singleCrafter.location}</span>
                      </p>
                      <div className="row">
                        <div className="col-sm-6">
                          ...
                          <p>
                            ...
                            <span>{"crafter.social.twitter"}</span>
                          </p>
                          <p>
                ...
                <section className="row crafter-activity-info">
                  <div>
                    ...
                    <p>
                      Makes a lot of paper designs from scrap and boxes them
                      into wonderful products that make for a daily doing.
                    </p>
                    <p>
                      2018, SEET awards winner for best paper mache, female
                      category
                    </p>
                  </div>
                </section>
                    ...
                    <div className="gallery-box">
                      <div className="row">
                        <span className="col-sm-3">
                          <img src={imgGalleryOne} />
                        </span>
                        <span className="col-sm-3">
                          <img src={imgGalleryTwo} />
                        </span>
                        <span className="col-sm-3">
                          <img src={imgGalleryThree} />
                        </span>
                        <span className="col-sm-3">
                          <img src={imgGalleryFour} />
                        </span>
                      </div>
                    </div>
                  </div>
